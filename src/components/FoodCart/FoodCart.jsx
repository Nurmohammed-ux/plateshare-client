...
const FoodCart = ({ food }) => {
  const {_id, food_image, food_name, quantity, pickup_location, pickup_time, expire_date}= food;  
  return (
    <div>
      <div
        key={_id}
      ...
      >
        ...
        <div className="card-body">
          ...
          <p className="text-sm text-gray-500">📍 {pickup_location}</p>
          <p className="text-sm text-gray-500">Pickup Time : {pickup_time}</p>
